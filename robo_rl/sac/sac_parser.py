...
parser.add_argument('--soft_update_tau', type=float, default=0.00005, help="target smoothening coefficient tau")
...
parser.add_argument('--scale_reward', type=float, default=3,
...
parser.add_argument('--loss_clip', type=bool, default=True)
...
parser.add_argument('--log_std_max', type=float, default=-5)

parser.add_argument('--target_update_interval', type=int, default=1,
                    help="used in case of hard update with or without td3")
parser.add_argument('--td3_update_interval', type=int, default=10,
