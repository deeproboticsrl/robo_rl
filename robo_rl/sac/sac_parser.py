...
parser.add_argument('--scale_reward', type=float, default=0.05,
...
parser.add_argument('--td3_update_interval', type=int, default=40,
...
parser.add_argument('--num_episodes', type=int, default=10001, help='number of episodes')
