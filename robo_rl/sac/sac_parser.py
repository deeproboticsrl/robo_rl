...
'''
soft_update_tau should be small
lr is dependant on optmizer .
td3_update_interval =1 mean td3 deactivated 
optimizer has to fixed internally
check if gradients aren't exploding  -- xavier initialization helps with this.
