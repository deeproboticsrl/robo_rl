...
12. [Data Augmentation Generative Adversarial Networks](https://arxiv.org/pdf/1711.04340.pdf)
13. [Skills from Videos](https://xbpeng.github.io/projects/SFV/2018_TOG_SFV.pdf)
14. [Deep Unsupervised Clustering with Gaussian Mixture Variational Autoencoders](https://arxiv.org/pdf/1611.02648.pdf)
15. [GAUSSIAN MIXTURE VAE: LESSONS IN VARIATIONAL INFERENCE, GENERATIVE MODELS, AND DEEP NETS](http://ruishu.io/2016/12/25/gmvae/)
16. [Alternative Priors for Deep Generative Models](https://www.ics.uci.edu/~enalisni/nalisnick_openAI_talk.pdf)
17. [VAE with a VampPrior](https://arxiv.org/pdf/1705.07120.pdf)
18. [Universal Lipschitz Functions](https://openreview.net/pdf?id=ryxY73AcK7)
19. [GO GRADIENT FOR EXPECTATION-BASED OBJECTIVES](https://openreview.net/pdf?id=ryf6Fs09YX)
20. [IB-GAN: DISENTANGLED REPRESENTATION LEARNING WITH INFORMATION BOTTLENECK GAN](https://openreview.net/pdf?id=ryljV2A5KX)
21. [Generative Adversarial Imitation from Observation](https://arxiv.org/pdf/1807.06158.pdf)
22. [Closing the Sim-to-Real Loop:Adapting Simulation Randomization with Real World Experience](https://arxiv.org/pdf/1810.05687.pdf)
