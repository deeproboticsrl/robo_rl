...
4. [DISCRIMINATOR-ACTOR-CRITIC:Addressing Sample Inefficiency and Reward Bias in Inverse Reinforcement Learning](https://arxiv.org/pdf/1809.02925.pdf)
...
5. [Alternative Priors for Deep Generative Models](https://www.ics.uci.edu/~enalisni/nalisnick_openAI_talk.pdf)
6. [VAE with a VampPrior](https://arxiv.org/pdf/1705.07120.pdf)
7. [Universal Lipschitz Functions](https://openreview.net/pdf?id=ryxY73AcK7)
8. [GO GRADIENT FOR EXPECTATION-BASED OBJECTIVES](https://openreview.net/pdf?id=ryf6Fs09YX)
