...
parser.add_argument('--reward_clip', type=bool, default=True, help="Whether to clip reward in each update")
...
parser.add_argument('--value_lr', type=float, default=0.003, help="learning rate for state value function")
parser.add_argument('--critic_lr', type=float, default=0.003, help="learning rate for state-action value function")
